...
* RMT-051 — Centralized audit log export configured. Files: `deploy/observability/logging/fluent-bit-configmap.yaml`, `deploy/observability/logging/fluent-bit-daemonset.yaml`, `deploy/observability/logging/fluent-bit-siem-externalsecret.yaml`. Severity: High. Owner: Observability. Status: Mitigated.
