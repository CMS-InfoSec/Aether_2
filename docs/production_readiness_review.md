...
* Track completion of RMT-001/002/008/009/011/012/013/015/016/018 so all mandatory secrets and TLS artifacts (FastAPI, Secrets Service, platform allowlists, compliance DSNs, Feast credentials, TLS client certs, Kraken API keys, ingress certificates, hardened streaming endpoints) are delivered by GitOps before the next deployment window.
