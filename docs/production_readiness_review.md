...
| Reliability & Observability | ❌ Needs Fix | Prometheus rules target metric names that no service exports (OMS/policy/risk/WS histograms, order-gateway counters, model canary histogram), the Kraken ingest Deployment never exposes `/metrics`, and there is no Service to route scrapes to the pod, leaving SLOs unsatisfied despite the kill-switch exporter being wired correctly. 【F:deploy/observability/prometheus/prometheus.yaml†L55-L152】【F:metrics.py†L525-L586】【F:kill_switch.py†L26-L175】【F:deploy/k8s/base/kraken-ws-ingest/deployment.yaml†L1-L40】【F:deploy/k8s/base/kraken-ws-ingest/kustomization.yaml†L1-L4】【F:services/kraken_ws_ingest.py†L1-L160】【6f6b28†L1-L2】【4ecd18†L1-L2】【a8ce36†L1-L2】 |
