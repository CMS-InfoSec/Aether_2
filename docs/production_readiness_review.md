...
* Track completion of RMT-001/002/008/009/011/012/013/015/016/018/021/024/025 so all mandatory secrets, TLS artifacts, and container images (FastAPI, Secrets Service, platform allowlists, compliance DSNs, Feast credentials, capital allocator DSNs, TLS client certs, Kraken API keys, ingress certificates, hardened streaming endpoints, Vault access, kraken-ws-ingest image) are delivered by GitOps before the next deployment window.
