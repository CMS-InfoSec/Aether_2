...
* RMT-057 — Compliance metadata tagging enabled in CI artifacts. Files: `.github/workflows/ci.yaml`, `.github/workflows/build-images.yaml`, `.github/workflows/main-pipeline.yml`. Severity: Low. Owner: Release Engineering. Status: Complete.
